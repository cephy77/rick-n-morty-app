...
import { CharacterInfo as Character } from '../../types/Character';

interface PropsTypes {
  character: Character
}

export const CharacterInfo = ({ character }: PropsTypes) => {
  ...
  return (
    <div className={style.card}>
      ...
      <article className={style.cardInfo}>
        ...
        <div className={style.cardGender}>
          <p className={style.cardGenderHeader}>Gender:</p>
          <p className={style.cardGenderInfo}>{character.gender}</p>
        </div>
        ...
        <div className={style.cardLocation}>
          <p className={style.cardLocationHeader}>Dimension:</p>
          <p className={style.cardLocationInfo}>{character.location.dimension}</p>
        </div>
